    ...
    for graph in graphs:
        ...
        while seqIndex >= 0:
            ...
            if seqIndex < seqLen - 1:
                valBelow = graph[seqIndex+1][0]

            valRight = graph[seqIndex][0]

            graph[seqIndex].insert(0, valRight - valBelow)

            print("r:", valRight, "b:", valBelow, "result", valRight - valBelow)

            if seqIndex == 0:
                finalSum += valRight - valBelow
